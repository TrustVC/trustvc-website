...
/**
 * Builds a permissionless smart account client for an EIP-7702 delegated EOA.
 * Requires MetaMask (window.ethereum) to sign the EIP-7702 authorization on first use.
 */
